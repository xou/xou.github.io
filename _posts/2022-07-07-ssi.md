...
* **Self-Sovereign Identity (SSI)** is the idea that, instead of having a central party
  ...
  identity are W3C’s Digital Identifiers (DID) and Verifiable Credentials (VC). These
...
It cannot be stressed enough that the only known wide-scale deployment of anything
related to W3C’s DID concept is the QR-code-on-paper based EU vaccination certificate.
